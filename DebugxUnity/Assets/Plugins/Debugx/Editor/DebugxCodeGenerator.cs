...
namespace DebugxLog.Editor
{
    ...
    /// </summary>
    public static class DebugxCodeGenerator
    {
        private const string DebugxClassPath = "Assets/Plugins/Debugx/Runtime/Debugx.cs";
        ...
        /// </summary>
        public static void GenerateDebugxClass()
        {
            ...
            sb.AppendLine();
            sb.AppendLine("#pragma warning disable IDE0002");
            ...
            sb.AppendLine("}");
            sb.AppendLine("#pragma warning restore IDE0002");
        ...
        /// </summary>
        [MenuItem("Tools/Debugx/Regenerate Debugx Class")]
